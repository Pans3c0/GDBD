...
--------------------------------------------------------
  ...
  CREATE TABLE OFICINAS 
   (	CODIGOOFICINA VARCHAR2(10) PRIMARY KEY, 
  ...
  CREATE TABLE EMPLEADOS 
   (	CODIGOEMPLEADO NUMBER(6) PRIMARY KEY, 
  ...
  CREATE TABLE CLIENTES 
   (	CODIGOCLIENTE NUMBER(6) PRIMARY KEY, 
	...
	CODIGOEMPLEADOREPVENTAS NUMBER(6), 
	LIMITECREDITO NUMBER(15,2)
   ) ;

  CREATE TABLE GAMASPRODUCTOS 
   (	GAMA VARCHAR2(50) PRIMARY KEY, 
  ...
  CREATE TABLE PRODUCTOS 
   (	CODIGOPRODUCTO VARCHAR2(15) PRIMARY KEY, 
	...
	DESCRIPCION CLOB, 
	CANTIDADENSTOCK NUMBER(8) NOT NULL, 
	PRECIOVENTA NUMBER(10,2) NOT NULL, 
	PRECIOPROVEEDOR NUMBER(10,2)
   ) ;

  CREATE TABLE PEDIDOS 
   (	CODIGOPEDIDO NUMBER(6) PRIMARY KEY, 
  ...
  CREATE TABLE DETALLEPEDIDOS 
   (	CODIGOPEDIDO NUMBER(6), 
	CODIGOPRODUCTO VARCHAR2(15) NOT NULL, 
	CANTIDAD NUMBER(4) NOT NULL, 
	PRECIOUNIDAD NUMBER(6,2) NOT NULL, 
...
--INSERTING into CLIENTES
SET DEFINE OFF;
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('1','DG Productions Garden','Daniel G','GoldFish','5556901745','5556901746','False Street 52 2 A',null,'San Francisco',null,'USA','24006','19','3000');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('6','Lasas S.A.','Antonio','Lasas','34916540145','34914851312','C/Leganes 15',null,'Fuenlabrada','Madrid','España','28945','8','154310');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('12','Lasas S.A.','Antonio','Lasas','34916540145','34914851312','C/Leganes 15',null,'Fuenlabrada','Madrid','España','28945','8','154310');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('13','Camunas Jardines S.L.','Pedro','Camunas','34914873241','34914871541','C/Virgenes 45','C/Princesas 2 1ºB','San Lorenzo del Escorial','Madrid','España','28145','8','16481');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('14','Dardena S.A.','Juan','Rodriguez','34912453217','34912484764','C/Nueva York 74',null,'Madrid','Madrid','España','28003','8','321000');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('16','Flores Marivi','Maria','Rodriguez','666555444','912458657','C/Leganés 24',null,'Fuenlabrada','Madrid','España','28945','5','1500');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('17','Flowers, S.A','Beatriz','Fernández','698754159','978453216','C/Luis Salquillo 4',null,'Montornes del valles','Barcelona','España','24586','5','3500');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('20','AYMERICH GOLF MANAGEMENT, SL','Mario','Suárez','964493072','964493063','C/Letardo',null,'Barcelona','Cataluña','España','12320','12','20000');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('28','Agrojardín','Benito','López','675432926','916549264','C/Mar Caspio 43',null,'Getafe','Madrid','España','28904','30','8040');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('29','Top Campo','Joseluis','Sánchez','685746512','974315924','C/Ibiza 32',null,'Humanes','Madrid','España','28574','5','5500');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('30','Jardineria Sara','Sara','Márquez','675124537','912475843','C/Lima 1',null,'Fenlabrada','Madrid','España','27584','5','7500');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('31','Campohermoso','Luis','Jiménez','645925376','916159116','C/Peru 78',null,'Fuenlabrada','Madrid','España','28945','30','3250');
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('32','france telecom','Francois','Toulou','(33)5120578961','(33)5120578961','6 place d Alleray 15',null,'Paris',null,'France','75010','16','10000');
...
Insert into CLIENTES (CODIGOCLIENTE,NOMBRECLIENTE,NOMBRECONTACTO,APELLIDOCONTACTO,TELEFONO,FAX,LINEADIRECCION1,LINEADIRECCION2,CIUDAD,REGION,PAIS,CODIGOPOSTAL,CODIGOEMPLEADOREPVENTAS,LIMITECREDITO) values ('38','El Jardín Viviente S.L','Justin','Smith','2 8005-7161','2 8005-7162','176 Cumberland Street The rocks',null,'Sydney','Nueva Gales del Sur','Australia','2003','31','8000');

--INSERTING into DETALLEPEDIDOS
SET DEFINE OFF;
...
--INSERTING into EMPLEADOS
SET DEFINE OFF;
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('1','Marcos','Magaña','Pérez','3897','marcos@es','TAL-ES',null,'Director General');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('2','Ruben','López','Martínez','2899','rlopez@es','TAL-ES','1','Subdirector Marketing');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('3','Alberto','Soria','Carrasco','2837','asoria@es','TAL-ES','2','Subdirector Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('4','Maria','Solís','Jerez','2847','msolis@es','TAL-ES','2','Secretaria');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('5','Felipe','Rosas','Márquez','2844','frosas@es','TAL-ES','3','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('6','Juan Carlos','Ortiz','Serrano','2845','cortiz@es','TAL-ES','3','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('7','Carlos','Soria','Jiménez','2444','csoria@es','MAD-ES','3','Director Oficina');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('8','Mariano','López','Murcia','2442','mlopez@es','MAD-ES','7','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('9','Lucio','Campoamor','Martín','2442','lcampoamor@es','MAD-ES','7','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('10','Hilario','Rodriguez','Huertas','2444','hrodriguez@es','MAD-ES','7','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('11','Emmanuel','Magaña','Pérez','2518','manu@es','BCN-ES','3','Director Oficina');
...
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('13','David','Palma','Aceituno','2519','dpalma@es','BCN-ES','11','Representante Ventas');
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('14','Oscar','Palma','Aceituno','2519','opalma@es','BCN-ES','11','Representante Ventas');
...
Insert into EMPLEADOS (CODIGOEMPLEADO,NOMBRE,APELLIDO1,APELLIDO2,EXTENSION,EMAIL,CODIGOOFICINA,CODIGOJEFE,PUESTO) values ('19','Walter Santiago','Sánchez','López','7454','wssanchez@gardening.com','SFC-USA','18','Representante Ventas');
...
Insert into PEDIDOS (CODIGOPEDIDO,FECHAPEDIDO,FECHAESPERADA,FECHAENTREGA,ESTADO,CODIGOCLIENTE) values ('98',to_date('08/01/09','DD/MM/RR'),to_date('13/02/09','DD/MM/RR'),null,'Pendiente','35');
...
Insert into PRODUCTOS (CODIGOPRODUCTO,NOMBRE,GAMA,DIMENSIONES,PROVEEDOR,CANTIDADENSTOCK,PRECIOVENTA,PRECIOPROVEEDOR) values ('FR-17','Rosal bajo 1ª -En maceta-inicio brotación','Frutales',null,'Frutales Talavera S.A','15','2','1');
...
--  Ref Constraints 
--------------------------------------------------------
  ALTER TABLE CLIENTES ADD CONSTRAINT CLI_REP_FK FOREIGN KEY (CODIGOEMPLEADOREPVENTAS)
	  REFERENCES EMPLEADOS (CODIGOEMPLEADO);

  ALTER TABLE DETALLEPEDIDOS ADD CONSTRAINT DET_PED_FK FOREIGN KEY (CODIGOPEDIDO)
	  REFERENCES PEDIDOS (CODIGOPEDIDO);
  ALTER TABLE DETALLEPEDIDOS ADD CONSTRAINT DET_PRO_FK FOREIGN KEY (CODIGOPRODUCTO)
	  REFERENCES PRODUCTOS (CODIGOPRODUCTO);

  ALTER TABLE EMPLEADOS ADD CONSTRAINT EMP_JEFE_FK FOREIGN KEY (CODIGOJEFE)
	  REFERENCES EMPLEADOS (CODIGOEMPLEADO);
  ALTER TABLE EMPLEADOS ADD CONSTRAINT EMP_OFI_FK FOREIGN KEY (CODIGOOFICINA)
	  REFERENCES OFICINAS (CODIGOOFICINA);

  ALTER TABLE PAGOS ADD CONSTRAINT PAGOS_CLI_FK FOREIGN KEY (CODIGOCLIENTE)
	  REFERENCES CLIENTES (CODIGOCLIENTE);

  ALTER TABLE PEDIDOS ADD CONSTRAINT PED_CLI_FK FOREIGN KEY (CODIGOCLIENTE)
	  REFERENCES CLIENTES (CODIGOCLIENTE);

  ALTER TABLE PRODUCTOS ADD CONSTRAINT PRO_GAM_FK FOREIGN KEY (GAMA)
